...
// Version 10.1
// Added functions to draw on the image. 
// These are still UNTESTED

// Future plans - really need to create a surface superclass, and subclass to make the engine and the picture
